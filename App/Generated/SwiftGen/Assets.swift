...
internal enum Asset {
  ...
  internal enum Images {
    ...
    internal static let time = UIImage(named: "time", in: Bundle(for: BundleToken.self), compatibleWith: nil)!
    internal static let trash = UIImage(named: "trash", in: Bundle(for: BundleToken.self), compatibleWith: nil)!
